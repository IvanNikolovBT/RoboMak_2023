...
if __name__ == "__main__":
    ...
    team_1 = [Player(team_1_properties['player_names'][0], weights[0], radiuses[0], accelerations[0], speeds[0], shot_powers[0]), 
              Player(team_1_properties['player_names'][1], weights[1], radiuses[1], accelerations[1], speeds[1], shot_powers[1]), 
              Player(team_1_properties['player_names'][2], weights[2], radiuses[2], accelerations[2], speeds[2], shot_powers[2])]
    team_2 = [Player(team_2_properties['player_names'][0], weights[0], radiuses[0], accelerations[0], speeds[0], shot_powers[0]), 
              Player(team_2_properties['player_names'][1], weights[1], radiuses[1], accelerations[1], speeds[1], shot_powers[1]), 
              Player(team_2_properties['player_names'][2], weights[2], radiuses[2], accelerations[2], speeds[2], shot_powers[2])]
